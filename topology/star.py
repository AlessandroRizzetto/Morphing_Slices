...
class StarTopo(app_manager.RyuApp):
    ...
    save_dst =['00:00:00:00:00:01','00:00:00:00:00:04','00:00:00:00:00:05','00:00:00:00:00:06' ,'00:00:00:00:00:07' ,'00:00:00:00:00:10']
    ...
    def _packet_in_handler(self, ev):
        ...
        if(switch_id == 7 and in_port != 1):
            out_port = 1
        elif((switch_id == 1 or switch_id == 5 or switch_id == 6 or switch_id == 10) and in_port != 4):
            out_port = 4
        else:
