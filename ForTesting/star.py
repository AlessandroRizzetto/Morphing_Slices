...
class StarTopo(app_manager.RyuApp):
    ...
    save_dst =['00:00:00:00:00:01','00:00:00:00:00:02','00:00:00:00:00:03', '00:00:00:00:00:04', '00:00:00:00:00:05', '00:00:00:00:00:06' , '00:00:00:00:00:07']
    ...
    def _packet_in_handler(self, ev):
        ...
        if(switch_id in self.cutted):
            return
        if((switch_id == 1 or switch_id == 2 or switch_id == 3) and in_port !=2):
            out_port = 2
        elif((switch_id == 1 or switch_id == 2 or switch_id == 3) and in_port == 2):
            out_port = 1
        elif((switch_id == 5 or switch_id == 6) and in_port !=3):
            out_port = 3
        else:
